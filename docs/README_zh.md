...
[文档](https://komari-document.pages.dev/) | [文档(镜像站 By Geekertao)](https://www.komari.wiki)
...
1. 访问 Komari 的 [GitHub Release 页面](https://github.com/kadidalax/komari-classic/releases) 下载适用于你操作系统的最新二进制文件。
2. 运行 Komari：
   ```bash
